(function($){
	...
	$.cnfol = {
		...
		search_base_url : "http://api.t.cnfol.com/",
		username : "helio",
		password : "welcome8298"
	}
	
	$.cnfol.urls = {
		search         : $.cnfol.search_base_url + "search",
		help_test      : $.cnfol.base_url + "help/test",
			
		trends         : $.cnfol.search_base_url + "trends",
		trends_current : $.cnfol.search_base_url + "trends/current",
		trends_daily   : $.cnfol.search_base_url + "trends/daily",
		trends_weekly  : $.cnfol.search_base_url + "trends/weekly",
